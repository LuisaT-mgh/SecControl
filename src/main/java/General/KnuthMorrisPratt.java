...
public class KnuthMorrisPratt implements ISearchAlgorithm {
    public static void main(String... args) {
        ...
        int position = knuthMorrisPratt.search(text.toCharArray(), pattern.toCharArray());
    ...
    public int search(char[] textChar, char[] patternChar) {
        String text = String.valueOf(textChar);
        String pattern = String.valueOf(patternChar);
        int n = text.length();
